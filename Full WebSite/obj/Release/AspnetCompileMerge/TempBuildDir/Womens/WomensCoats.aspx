<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WomensCoats.aspx.cs" Inherits="FullWebSite.Womens.WomensJackets" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid bg- bg-white">
        ...
        <div class="container mt-5">
            <div class="row">
           <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:comfy_string %>" SelectCommand="select * from tbl_product_items where  pro_fk_subcat = 2"></asp:SqlDataSource>
